    ...
    <>
      <div className=" ">
        {coins.isLoading ? (
          ...
          <table className="w-full mt-16 relative px-4 z-10 ">
            <thead>
              <tr className="border-b">
                <th className="text-left pb-4">Coin</th>
                <th className="text-left pb-4 hidden sm:table-cell">Name</th>
                <th className="text-left pb-4">Price</th>
                <th className="text-left pb-4">24h</th>
                <th className="text-left pb-4 hidden sm:table-cell">Total Volume</th>
                <th> </th>
              </tr>
            </thead>
